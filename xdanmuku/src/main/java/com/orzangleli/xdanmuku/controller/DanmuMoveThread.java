...
public class DanmuMoveThread extends Thread {
    ...
    private int UPDATE_INTERVAL_TIME_MILLS = 10;
    private int mWidth = -1;
    private boolean mIsDestory = false;
    private int MAX_LINE_NUMS = 10;
...
//            Log.i("lxc", "4 ---> 5:" + (time5-time4));
            try {
                Thread.sleep(UPDATE_INTERVAL_TIME_MILLS);
...
//        int bestLineNum = 0;
//        SimpleDanmuVo bestLineLastDanmuVo = null;
//        for (int i = 0; i < lineLastDanmuVoArray.size(); i++) {
//            SimpleDanmuVo simpleDanmuVo = lineLastDanmuVoArray.valueAt(i);
//            SimpleDanmuVo temp = mDanmuController.getTheMoreRightDanmuVo(bestLineLastDanmuVo, simpleDanmuVo, mWidth);
//            if (temp == simpleDanmuVo) {
//                bestLineNum = bestLineLastDanmuVo == null ? 0 : bestLineLastDanmuVo.getLineNum();
//            } else {
//                bestLineNum = simpleDanmuVo == null ? 0 : simpleDanmuVo.getLineNum();
//            }
//            // 如果当前的弹幕还没有显示完，那么就放弃这次比较
//            if (temp == null || temp.getPadding() < temp.getWidth()) {
//                bestLineNum = -1;
//            }
//            bestLineLastDanmuVo = temp;
//        }
//        return bestLineNum;
//    }
